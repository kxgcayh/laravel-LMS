...
<body class="authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('register') }}" method="POST" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" @if ($errors->has('name')) is-invalid @endif" name="name" type="text" id="fullname"
    ...
    <footer class="footer footer-alt">
        ...
        </script> &copy; LearningManagementSystem theme by <a href="" class="text-white-50">Coderthemes</a>
    </footer>
